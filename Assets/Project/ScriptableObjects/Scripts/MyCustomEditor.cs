...
namespace RandomWeapons.Editor
{
    ...
    {
        public static WeightValueLayerList<T> WeightLayerGUIObject<T>(string name, WeightValueLayerList<T> layer, WeightLayerChanger changer) where T : UnityEngine.Object
        {
        ...
        public static WeightValueLayerList<int> WeightLayerGUIInt
            (string name, WeightValueLayerList<int> layer, WeightLayerChanger changer,int? minSize = null, int? maxSize = null)
        {
            GUILayout.BeginVertical();
